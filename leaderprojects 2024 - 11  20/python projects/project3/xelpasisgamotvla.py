...
kvirashi_1xel_raodenoba = 7
kvirashi_2jer_raodenoba = 18
kvirashi_3jer_raodenoba = 0
kvirashi_4jer_raodenoba = 1
...
if speed_count <= 20: 
    ...
    xelpasi_baratebit = razmis_xelpasi - (razmis_xelpasi / 100 * baratebis_saboloo_procenti) + green_card * 2
    print("xelpasi baratebit = " + str(xelpasi_baratebit))
    saboloo_xelpasi = razmis_xelpasi - (razmis_xelpasi / 100 * baratebis_saboloo_procenti) + green_card * 2 - jarima_1 - jarima_2 - miniliderebis_jarimebi
    print("saboloo xelpasi = " + str(saboloo_xelpasi))
elif speed_count <= 25: 
    wage_per_speed = 7
    razmis_xelpasi = ((kvirashi_1xel * wage_per_speed) + (kvirashi_2jer * wage_per_speed) + (kvirashi_3jer / 3 * 2.66 * wage_per_speed) + (kvirashi_4jer / 4 * 3.33 * wage_per_speed))
    print("razmis xelpasi = " + str(razmis_xelpasi))
